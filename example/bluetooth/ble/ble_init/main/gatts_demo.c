...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    {
        ESP_LOGW(GATTS_TAG, "ADD_CHAR_EVT, status %d, attr_handle %d, service_handle %d\n",
                 param->add_char.status, param->add_char.attr_handle, param->add_char.service_handle);
        if (param->add_char.char_uuid.len == ESP_UUID_LEN_16 && param->add_char.char_uuid.uuid.uuid16 == GATTS_CHAR_UUID_TEST_C)
        {
            break;
        }
    ...
    case ESP_GATTS_ADD_CHAR_DESCR_EVT:
    {
        ...
        c_char_uuid.uuid.uuid16 = GATTS_CHAR_UUID_TEST_C;
        esp_ble_gatts_add_char(gl_profile_tab[PROFILE_A_APP_ID].service_handle, &c_char_uuid,
                               ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
...
void app_main(void)
{
    ...
    ESP_LOGW(GATTS_TAG, "ble_start_initinit -----------");
    vTaskDelay(5000 / portTICK_PERIOD_MS);
    ESP_LOGW(GATTS_TAG, "ble_start_deinit -----------");
    ble_deinit();

    vTaskDelay(1000 / portTICK_PERIOD_MS);
    ESP_LOGW(GATTS_TAG, "ble_start_init twice----------- ");
    ble_init();
