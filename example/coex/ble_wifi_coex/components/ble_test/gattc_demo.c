...
static const char remote_device_name[] = "meizutest";
...
static void ble_scan(void *pvParameters)
{
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_SCAN_PARAM_SET_COMPLETE_EVT: {
        ...
        xTaskCreate(ble_scan, "ble_scan", 4096, NULL, 5, NULL);
        break;
    }
    ...
    case ESP_GAP_BLE_SCAN_RESULT_EVT: {
        ...
        case ESP_GAP_SEARCH_INQ_RES_EVT:
            ...
            if (500 == count ) {
                ESP_LOGI(GATTC_TAG, "scan count finish 500 times,count return to 0");
                count = 0;
            }
