...
#define EXAMPLE_ESP_STA_MAXIMUM_RETRY  CONFIG_ESP_STA_MAXIMUM_RETRY
                                ...
                                int32_t event_id, void* event_data)
{
    if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) {
        ...
        if (s_retry_num < EXAMPLE_ESP_STA_MAXIMUM_RETRY) {
            esp_wifi_connect();
            s_retry_num++;
...
void wifi_init_sta_softap(void)
{
    ...
    ESP_LOGI(TAG, "wifi_init_sta AP finished.");
